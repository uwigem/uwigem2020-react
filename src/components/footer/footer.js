        ...
        <div className="container-fluid">
          <div className="row" style= {{textAlign: 'center'}}>
            <div className="col" style= {{textAlign: 'center'}}>
              <a href="https://www.facebook.com/UWiGEMTeam/"><img src="https://2017.igem.org/wiki/images/1/1e/T--Washington--FacebookIcon.png" alt="Washington iGEM Facebook" style={{height: '50px', width: 'auto', padding: '1px'}}/></a>
              ...
              <a href="https://github.com/uwigem/uwigem2017"><img src="https://2017.igem.org/wiki/images/e/ec/T--Washington--GithubIcon.png" alt="Washington iGEM Github" style={{height: '50px', width: 'auto', padding: '1px'}}/></a>
